...
exports.getSalesForBusiness = async (req, res) => {
    try {
      ...
      if (!userOwnsBusiness) {
        return res.status(403).json({ message: 'You do not have permission to view sales for this business.' });
      }
...
exports.getSaleById = async (req, res) => {
    try {
      ...
      if (!userOwnsBusiness) {
        return res.status(403).json({ message: 'You do not have permission to view this sale.' });
      }
...
exports.updateSale = async (req, res) => {
    try {
      ...
      if (!userOwnsBusiness) {
        return res.status(403).json({ message: 'You do not have permission to update this sale.' });
      }
...
exports.deleteSale = async (req, res) => {
    try {
      ...
      if (!userOwnsBusiness) {
        return res.status(403).json({ message: 'You do not have permission to delete this sale.' });
      }
